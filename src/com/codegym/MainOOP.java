...
public class MainOOP {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 5: {
                    System.out.println("---Xắp xếp theo giá tăng dần---");
                    productManagement.priceIncreasingSort();
                    break;
                }

                case 6: {
                    System.out.println("---Xắp xếp theo giá giảm dần---");
                    productManagement.priceDecreasingSort();
                    break;
                }
    ...
    public static void menu() {
        ...
        System.out.println("5. xắp xếp theo giá tăng dần");
        System.out.println("6. Xắp xếp theo giá giá giảm dần");
